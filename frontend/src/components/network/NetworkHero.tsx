...
export const NetworkHero: React.FC<NetworkHeroProps> = ({
  ...
  // Dynamic active hidden path (prioritizes active traced relationship)
  ...
  }, [activeHiddenRelationship, allHiddenPath]);
  ...
  const displayedNodes = useMemo(() => {
    ...
    if (activeHiddenRelationship) {
      ...
      activeHiddenRelationship.pathNodeIds.forEach((id) => {
    ...
    return base;
  }, [rankedNodes, entityLimit, activeHiddenRelationship, allNodes]);
    ...
    <div className="p-5 xl:p-6 space-y-5 font-body">
      ...
      <div className="grid grid-cols-12 gap-4 xl:gap-5">
        ...
        <aside className="col-span-12 xl:col-span-4 flex flex-col gap-4">
          ...
          {/* Discovered Relationship Path & Hidden Lead Card */}
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground mt-1 leading-relaxed">
                {activeHiddenRelationship?.discoverySummary || (
                  `${Math.max(1, effectiveHiddenPath.length - 1)} hops through discovered multi-source linkages`
                )}
              </p>
